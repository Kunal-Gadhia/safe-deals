...
public class PrivateAmenities {
    ...
    public boolean equals(Object obj) {
        ...
        final PrivateAmenities other = (PrivateAmenities) obj;
    ...
    public String toString() {
        return "PrivateAmenities{" + "id=" + id + ", name=" + name + ", description=" + description + ", userId=" + userId + ", lastUpdatedTimeStamp=" + lastUpdatedTimeStamp + '}';
    }
