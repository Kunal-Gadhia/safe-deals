 ...
 * @author hp
 */
public class BusinessAssociates {
    ...
    public String toString() {
        return "BusinessAssociates{" + "id=" + id + ", userId=" + userId + ", mission=" + mission + ", vision=" + vision + ", moto=" + moto + ", fbLink=" + fbLink + ", twitterLink=" + twitterLink + ", youTubeLink=" + youTubeLink + ", websiteLink=" + websiteLink + ", mainOfficeAddress=" + mainOfficeAddress + ", branchOfficeAddress=" + branchOfficeAddress + '}';
    }
    ...
    public boolean equals(Object obj) {
        ...
        final BusinessAssociates other = (BusinessAssociates) obj;
