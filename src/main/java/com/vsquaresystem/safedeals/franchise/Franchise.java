...
public class Franchise {
    ...
    public String toString() {
        return "Franchise{" + "id=" + id + ", name=" + name + ", address=" + address + ", cityId=" + cityId + ", locationId=" + locationId + ", email=" + email + ", phoneNumber1=" + phoneNumber1 + ", phoneNumber2=" + phoneNumber2 + ", fax=" + fax + '}';
    }
